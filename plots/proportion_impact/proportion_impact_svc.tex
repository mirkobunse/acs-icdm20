...
\begin{document}
\begin{tikzpicture}
\begin{axis}[rank axis, scale=0.66, title={support vector classifier\strut}]

  \rankplot{3clusters}{rank plot 01}{svc_ProportionalLabelScore_3clusters.csv}
  \rankplot{spirals}{rank plot 02}{svc_ProportionalLabelScore_spirals.csv}
  \rankplot{vertebral}{rank plot 03}{svc_ProportionalLabelScore_vertebral.csv}
  \rankplot{yeast}{rank plot 04}{svc_ProportionalLabelScore_yeast.csv}
  \rankplot{vehicle}{rank plot 05}{svc_ProportionalLabelScore_vehicle.csv}

  % round-robin error bars
  \rankerror{9,54}{rank plot 01}{svc_ProportionalLabelScore_3clusters.csv}
  \rankerror{27,72}{rank plot 02}{svc_ProportionalLabelScore_spirals.csv}
  \rankerror{36,81}{rank plot 03}{svc_ProportionalLabelScore_vertebral.csv}
  \rankerror{45,90}{rank plot 04}{svc_ProportionalLabelScore_yeast.csv}
  \rankerror{16,64}{rank plot 05}{svc_ProportionalLabelScore_vehicle.csv}
